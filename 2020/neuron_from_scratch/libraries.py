...
class Activation_ReLU:
    ...
    def backward(self, dvalues):
        ...
        # update element to 0 if value lower than 0
...
class Optimizer_SGD_version2:
    ...
    def pre_update_params(self):
        if self.decay:
            self.current_learning_rate = self.starting_learing_rate * \
...
# Optimizer_AdGrad adaptive gradient Chapter 10 page 52
# Result: AdaGrad worked quite well here, but not as good as SGD with momentum, and we can see that loss consistently fell throughout the entire training proces
class Optimizer_AdaGrad:
    ...
    def update_params(self, layer):
     ...
     # If layer does not contain cache arrays, create them  array filled with zeros
        ...
        #  Vanila SGD parameter update + normalization with squred rooted cache
...
# RMSprop optimizer
# Result: Pretty good result, close to SGD with momentum but not as good.
